...
if not finetuned:
    ...
    path_to_adapter = '/nlp/scr/ram1998/cs231n-final-project/InternLM-XComposer/InternLM-XComposer-2.0/finetune/output_1_8b_lora_on_bar_and_line_chart_new_lora_try_1/finetune'
    ...
    filename = 'model_eval_1_8b_new_working_v1_on_460_sample_barchart_and_linechart_randomized_llm_as_judge.pkl'
